const boilers = [
  {
    ...
    boilerCount: 1,
    available: 2,
    sliderDescription: "Установка 0,5 МВт, 1 котел",
    fullDescription:
...

  {
    ...
    sliderDescription: "Котельная 1,0 МВт, 2 котла",
    purpose: "Теплоснабжение",
    typeDescription: "Блочно-модульная автоматизированная котельная",
  ...
  },
  {
    ...
    sliderDescription: "Котельная 1,04 МВт, 1 котел",
    purpose: "Теплоснабжение",
    typeDescription: "Блочно-модульная автоматизированная котельная",
    manufactureDate: "Январь - 2024г",
    bmkBuilding: "На базе морского контейнера 20футов",
  ...
  },
  {
    ...
    sliderDescription: "Котельная 1,2 МВт, 1 котел",
    purpose: "Теплоснабжение",
    typeDescription: "Блочно-модульная автоматизированная котельная",
  ...
  },
  {
    ...
    sliderDescription: "Котельная 1,4 МВт, 1 котел",
    purpose: "Теплоснабжение",
    typeDescription: "Блочно-модульная автоматизированная котельная",
  ...
  },
  {
    ...
    sliderDescription: "Котельная 1,6 МВт, 1 котел",
    purpose: "Теплоснабжение",
  ...
  },
  {
    ...
    sliderDescription: "Котельная 4,8 МВт, 2 котла",
    purpose: "Теплоснабжение",
    typeDescription: "Автоматизированная газовая горелка",
    manufactureDate: "Ноябрь - 2022г.",
  ...
  },
  {
    ...
    sliderDescription: "Котельная 6 МВт, 2 котла",
    purpose: "Теплоснабжение",
    typeDescription: "Автоматизированная газовая горелка",
    manufactureDate: "Ноябрь - 2022г.",
  ...
  },
  {
    ...
    sliderDescription: "Котельная 6,1 МВт, 2 котла",
    purpose: "Теплоснабжение",
    typeDescription: "Автоматизированная газовая горелка",
    manufactureDate: "Ноябрь - 2022г.",
    boiler: "Bosch UT-L24",
  ...
  },
  {
    ...
    sliderDescription: "Котельная 7,4 МВт, 2 котла",
    purpose: "Теплоснабжение",
    typeDescription: "Автоматизированная газовая горелка",
    manufactureDate: "Ноябрь - 2022г.",
    boiler: "Bosch UT-L28",
